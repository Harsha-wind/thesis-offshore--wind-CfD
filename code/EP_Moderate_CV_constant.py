"""
Scenario 2: Moderate - Mehta-Aligned Renewable Penetration (Denmark)
...
OUTPUT_PRICES = "results/DK/EP/moderate/future_prices_scenario_moderate_DK.csv"
OUTPUT_STATS = "results/DK/EP/moderate/scenario2_moderate_stats_DK.csv"
