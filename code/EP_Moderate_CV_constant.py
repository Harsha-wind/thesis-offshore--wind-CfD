...
# Output files
OUTPUT_PRICES = "E:/Thesis_Project/thesis_data/results/DK/EP/moderate/future_prices_Scenario_moderate.csv"
OUTPUT_STATS = "E:/Thesis_Project/thesis_data/results/DK/EP/moderate/scenario2_moderate_stats.csv"
OUTPUT_PLOT = "E:/Thesis_Project/thesis_data/results/DK/EP/moderate/scenario2_moderate_plot.png"
...
# Target by 2032 (Mehta baseline scenario)
TARGET_MEAN_2032 = 45.0       # Significant decline (Mehta: 50-70 EUR range)
TARGET_CV_2032 = 0.81         # CONSTANT (no change)
TARGET_CORRELATION_2032 = -0.55  # Moderate-strong cannibalization

# Price floor
#PRICE_FLOOR = -25  # EUR/MWh

# ============================================================================
# SCENARIO INFO
# ============================================================================

SCENARIO_NAME = "Moderate - Mehta-Aligned Renewable Penetration"
SCENARIO_DESC = "CV constant, significant price decline with moderate cannibalization"
...
print(f"  Significant renewable penetration captured through price decline")
...
if neg_total > 0:
    ax1.fill_between(duration, sorted_p, 0, where=(sorted_p<0), color='red', alpha=0.3)
...
ax2.set_title("Wind Cannibalization Effect", fontweight='bold', fontsize=11)
ax2.set_xlabel("Wind Speed (m/s)")
ax2.set_ylabel("Price (EUR/MWh)")
ax2.legend()
ax2.grid(alpha=0.3)

# Plot 3: Mean Evolution with Neg Hours
ax3 = axes[0, 2]
...
ax3_twin = ax3.twinx()
ax3_twin.bar(stats_df['Year'], stats_df['Negative_Pct'], alpha=0.3, color='red', label='Neg %')
ax3.set_title("Mean Price & Negative Hours", fontweight='bold', fontsize=11)
ax3.set_xlabel("Year")
...
ax5.fill_between(stats_df['Year'], stats_df['Target_Rho'], 0, alpha=0.2, color='orange')
...
plt.suptitle(f"Scenario 2: {SCENARIO_NAME}\n"
...
print(f"  Aligned with Mehta baseline scenario (50-70 EUR/MWh range)")
print("="*80)